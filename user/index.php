...
while($row=mysql_fetch_array($data)){
	...
	?>
				<li class="span3">
				  ...
				  <div class="thumbnail">
					<a  href="product_details.php?id=<?php echo $row['itemid'];?>"><img src="../admin/examples/<?php echo $row['imgid'];?>" alt=""/></a>
					<div class="caption">
					  <h5><?php echo$row['itemname'];?></h5>
					  
					 
					  <h4 style="text-align:center"><a class="btn" href="product_details.php?id=<?php echo $row['itemid'];?>"> <i class="icon-zoom-in"></i></a>  <a class="btn btn-primary" href="#"><?php echo $row['rate'];?></a></h4>
					</div>
				  </div>
